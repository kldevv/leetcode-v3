...
class Solution:
    def differenceOfDistinctValues(self, grid: List[List[int]]) -> List[List[int]]:
        ...
        # Iterate over the diagonals above the main diagonal
        for i in range(cols):
            r = 0
            c = i
            dis = set()
        ...
        # Iterate over the diagonals below the main diagonal
        ...
        # Iterate over the diagonals above the main diagonal in reversed order
        for i in range(rows-1, -1, -1):
            r = i
            c = cols - 1
            dis = set()
            while r >= 0 and c >= 0:
                out[r][c] = abs(out[r][c] - len(dis))
                dis.add(grid[r][c])
                r -= 1
                c -= 1

        # Iterate over the diagonals below the main diagonal in reversed order
